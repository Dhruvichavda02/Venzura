...
<body>
    ...
    <button class="btn add-role-btn" onclick="window.location.href='AddMusic.jsp'">Add Musician</button>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td data-label="Policy">Music </td>
                        <td data-label="Edit"><button class="edit-btn" onclick = "window.location.href='EditMusic.jsp'">Edit</button></td>
                        <td data-label="Delete"><button class="del-btn" onclick="confirmDelete(this)">Del</button></td>

                    </tr>
                    <tr>
                        <td data-label="#">2</td>
                        <td data-label="Name"><strong>Ahmad Rosser</strong><br></td>
                        <td data-label="Location">Lorem ipsum dolor sit amet...</td>
                        <td data-label="Experience">Lorem ipsum dolor sit amet...</td>
                        <td data-label="Price">10k</td>
                        <td data-label="Policy">Host</td>
                     ...
                     <tr>
                        <td data-label="#">3</td>
                        <td data-label="Name"><strong>Joey Rosser</strong><br></td>
                        <td data-label="Location">Lorem ipsum dolor sit amet...</td>
                        <td data-label="Experience">Lorem ipsum dolor sit amet...</td>
                        <td data-label="Price">10k</td>
                        <td data-label="Policy">Host</td>
                     ...
                     <tr>
                        <td data-label="#">5</td>
                        <td data-label="Name"><strong>Chandler Bing</strong><br></td>
                        <td data-label="Location">Lorem ipsum dolor sit amet...</td>
                        <td data-label="Experience">Lorem ipsum dolor sit amet...</td>
                        <td data-label="Price">10k</td>
                        <td data-label="Policy">Host</td>
